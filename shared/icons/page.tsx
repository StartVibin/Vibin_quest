                        ...
                        {leaderboardLoading && !leaderboardData ? (
                            ...
                            [...Array(6)].map((_, index) => (
                                <div key={index} className={styles.ratingTableItem}>
                                    <p className={cn(styles.ratingTableText, styles.ratingTableRank)}>
                                        <div className="animate-pulse bg-gray-200 h-4 w-8 rounded"></div>
                                    </p>
                                    <p className={cn(styles.ratingTableText, styles.ratingTableWallet)}>
                                        <div className="animate-pulse bg-gray-200 h-4 w-24 rounded"></div>
                                    </p>
                                    <p className={cn(styles.ratingTableText, styles.ratingTablePoints)}>
                            ...
                            leaderboardData.users.map((user, index) => (
                                <div key={user.walletAddress} className={styles.ratingTableItem}>
                                    <p
                                        className={cn(
                ...
                >
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: 0 }}>Invite Friends</h3>
                            <button
